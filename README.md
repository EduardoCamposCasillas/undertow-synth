...
> **Estado:** en desarrollo (fases 1–4 de 11 completadas). Ya suena y es usable en un DAW, pero todavía no tiene
> modulación, segundo oscilador, efectos ni presets. Ver la [hoja de ruta](#hoja-de-ruta).
...
Source/
  ...
  dsp/                oscilador, wavetables, filtro, envolvente y FFT (sin dependencias de JUCE)
  synth/              voces, gestión de polifonía y banco de wavetables
  gui/                visores propios (forma de onda y curva del filtro)
...
- [x] 4 — Filtros ZDF/TPT
- [ ] 5 — Modulación: envolventes extra, LFOs y matriz de modulación
